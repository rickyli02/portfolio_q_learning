...
- [Model layer design decisions](project_design_decisions_models.md) — numerical safety guard policy, QuadraticCritic terminal condition, GaussianActor docstring convention
